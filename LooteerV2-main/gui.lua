...
gui.elements = {
   ...
   affix_settings = {
      tree = tree_node:new(1),
      magic_greater_affix_slider = slider_int:new(0, 3, 0, get_hash(plugin_label .. "_magic_greater_affix_slider")),
      rare_greater_affix_slider = slider_int:new(0, 3, 0, get_hash(plugin_label .. "_rare_greater_affix_slider")),
...
function gui.render()
   ...
   if gui.elements.affix_settings.tree:push("Affix Settings") then
      gui.elements.affix_settings.magic_greater_affix_slider:render("Magic GA Count",
      "Minimum GA's to consider picking up magic (blue) items. Set to 0 to pick up all magic items.")
      gui.elements.affix_settings.rare_greater_affix_slider:render("Rare GA Count",
      "Minimum GA's to consider picking up rare (yellow) items. Set to 0 to pick up all rare items.")
   ...
   if gui.elements.item_types.tree:push("Item Types") then
      ...
      gui.elements.item_types.goblin_cache_toggle:render("Goblin Cache", "Do you want to loot Treasure Goblin cache bags?")
      gui.elements.item_types.obols_toggle:render("Obols", "Do you want to loot Obols?")
