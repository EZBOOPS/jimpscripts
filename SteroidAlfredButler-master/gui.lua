...
function gui.render()
    ...
    if gui.elements.talisman_tree:push('Talisman') then
        gui.elements.stash_talisman:render('Enable Talisman Features', 'Master toggle for all talisman handling (stash keepers, salvage at Occultist)')
        -- Seal
        render_menu_header('--- Seal ---')
        gui.elements.talisman_seal_action:render('Seal default action', {'Keep', 'Salvage'}, 'What to do with seals by default')
        gui.elements.talisman_seal_affix_filter_toggle:render('Use affix filter (Seal)', 'Keep seals that have >= N of your checked affixes')
        ...
        -- Charm
        render_menu_header('--- Charm ---')
        gui.elements.talisman_charm_action:render('Charm default action', {'Keep', 'Salvage'}, 'What to do with charms by default')
        gui.elements.talisman_charm_affix_filter_toggle:render('Use affix filter (Charm)', 'Keep charms that have >= N of your checked affixes')
